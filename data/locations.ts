...
export const locations: LocationPage[] = [
  {
    ...
    subtitle:
      "Bridal, soft glam, and event makeup — delivered to your doorstep in Lekki Phase 1, Phase 2, Chevron, Ajah, and Sangotedo.",
    seoTitle: "Makeup Artist in Lekki Lagos — Bridal & Event Glam",
    seoDescription:
      `Book a professional makeup artist in Lekki, Lagos. ${siteConfig.brand} offers bridal makeup, soft glam, traditional wedding makeup, and event glam with home service across Lekki Phase 1, Phase 2, Ajah, Chevron, and VGC.`,
    intro: [
      `Looking for a reliable makeup artist in Lekki? ${siteConfig.brand} brings professional bridal, event, and soft glam makeup directly to you — whether you're getting ready at home, a hotel, or a venue anywhere in Lekki.`,
  ...
  },
  {
    ...
    subtitle:
      "Luxury bridal and event makeup for VI, Ikoyi, Oniru, and Banana Island — with punctual home service and a polished, lasting finish.",
    seoTitle: "Makeup Artist in Victoria Island Lagos — Bridal & Luxury Glam",
    seoDescription:
      `Book a professional makeup artist in Victoria Island, Lagos. ${siteConfig.brand} provides bridal makeup, soft glam, and event makeup with home service across VI, Ikoyi, Oniru, and Banana Island.`,
    intro: [
  ...
  },
  {
    ...
    subtitle:
      "Professional bridal, traditional, and event makeup with home service across Ikeja, GRA, Maryland, Magodo, and Omole.",
    seoTitle: "Makeup Artist in Ikeja Lagos — Bridal, Event & Home Service",
    seoDescription:
      `Book a makeup artist in Ikeja, Lagos. ${siteConfig.brand} offers bridal makeup, event glam, traditional wedding makeup, and soft glam with home service across Ikeja GRA, Maryland, Magodo, Omole, and Ojodu.`,
    intro: [
  ...
  },
  {
    ...
    subtitle:
      "Bridal and event makeup with home service in Surulere, Yaba, Gbagada, Shomolu, and surrounding areas.",
    seoTitle: "Makeup Artist in Surulere & Yaba Lagos — Bridal & Event Makeup",
    seoDescription:
      `Book a professional makeup artist in Surulere and Yaba, Lagos. ${siteConfig.brand} offers bridal makeup, event glam, and soft glam with home service across Surulere, Yaba, Gbagada, Shomolu, and Ogudu.`,
    intro: [
  ...
  },
  {
    ...
    subtitle:
      "Professional bridal and event makeup with home service across Festac, Amuwo-Odofin, Oshodi, Isolo, and Egbeda.",
    seoTitle: "Makeup Artist in Festac & Oshodi Lagos — Bridal & Event Glam",
    seoDescription:
      `Book a professional makeup artist in Festac and Oshodi, Lagos. ${siteConfig.brand} offers bridal makeup, event glam, traditional wedding makeup, and home service across Festac, Amuwo-Odofin, Isolo, Egbeda, and Idimu.`,
    intro: [
  ...
  },
  {
    ...
    subtitle:
      "Professional bridal, traditional, and event makeup — now available with home service in Ikorodu, Epe, Badagry, Alimosho, and Agbara.",
    seoTitle: "Makeup Artist in Ikorodu & Epe Lagos — Bridal & Event Makeup",
    seoDescription:
      `Book a professional makeup artist in Ikorodu and Epe, Lagos. ${siteConfig.brand} provides bridal makeup, event glam, and traditional wedding makeup with home service in Ikorodu, Epe, Badagry, Alimosho, and Agbara.`,
    intro: [
