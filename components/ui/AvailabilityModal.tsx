...
export function AvailabilityModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md bg-card rounded-t-2xl sm:rounded-2xl border border-border shadow-xl modal-panel-enter flex flex-col max-h-[92vh] sm:max-h-[88vh]">
        {/* Fixed header */}
        <div className="shrink-0 px-5 pt-5 pb-3">
          ...
          <h3 className="font-display text-xl text-text-primary mb-0.5 text-center">
            Check Availability
          </h3>
          <p className="text-xs text-text-muted text-center">
            Pick a date, then continue to book.
          </p>
        </div>

        {/* Scrollable calendar area — no visible scrollbar */}
        ...
        <div className="shrink-0 px-5 pb-5 pt-3">
          <button
            ...
            className={cn(
              "w-full rounded-full py-3 font-medium text-sm transition-all duration-300",
              selectedDate
