...
const blogPosts = [
  ...
  },
  {
    ...
    body: [
      ...
      { _type: "block", _key: "bp6-b3", style: "normal", markDefs: [], children: [{ _type: "span", _key: "bp6-b3-s1", text: "No matter your skin type — oily, dry, or combination — you need to moisturize before applying any makeup. If your skin is on the drier side, overcompensate with hydration. Use a glow serum or hydrating moisturizer and let it sink in for at least 10 minutes before moving to primer. This waiting time is crucial because if you rush it, your foundation can separate or peel.", marks: [] }] },
      { _type: "block", _key: "bp6-b4", style: "normal", markDefs: [], children: [{ _type: "span", _key: "bp6-b4-s1", text: "Next, apply an illuminating primer all over your face. If you have oily skin, focus the primer on your T-zone and eyelids — this prevents your eyeshadow from creasing and helps your makeup last all day. An illuminating primer gives soft glam that beautiful lit-from-within glow, but if you prefer a more matte finish, a mattifying primer works too. The key is letting each layer absorb before adding the next.", marks: [] }] },
  ...
  },
  {
    ...
    body: [
      ...
      { _type: "block", _key: "bp7-b3", style: "normal", markDefs: [], children: [{ _type: "span", _key: "bp7-b3-s1", text: "Every long-lasting makeup application starts with skincare, not foundation. Moisturize your face even if you have oily skin — oily skin that is dehydrated actually produces more oil to compensate. Apply a lightweight moisturizer or glow serum, then wait at least 10 minutes before applying primer. This is the step most people skip, and it is the reason their primer pills up or their foundation separates later in the day.", marks: [] }] },
      { _type: "block", _key: "bp7-b4", style: "normal", markDefs: [], children: [{ _type: "span", _key: "bp7-b4-s1", text: "Your skincare and primer also need to be compatible. If your moisturizer is water-based and your primer is silicone-based, they can conflict and cause pilling. Check your product ingredients and keep them in the same family. When in doubt, use a primer from the same brand as your foundation — they are usually formulated to work together.", marks: [] }] },
      ...
      { _type: "block", _key: "bp7-b6", style: "normal", markDefs: [], children: [{ _type: "span", _key: "bp7-b6-s1", text: "In Lagos heat, less foundation means longer wear. Instead of covering your entire face in a thick layer, apply a thin layer all over and then spot-conceal only where you need it — hyperpigmentation, dark circles, blemishes. A foundation that is too heavy will slide off faster because there is simply more product for the heat and humidity to break down.", marks: [] }] },
