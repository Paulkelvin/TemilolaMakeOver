  ...
  return (
    <html lang="en" className={`${cormorant.variable} ${jakarta.variable}`}>
      ...
      <body className="min-h-screen antialiased font-body">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:top-4 focus:left-4 focus:rounded-full focus:bg-accent-rose focus:text-white focus:px-4 focus:py-2 focus:text-sm focus:font-medium"
        >
          Skip to content
        </a>
        <Header blockedDates={blockedDates} services={services} />
