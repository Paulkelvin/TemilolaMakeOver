  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666; width: 140px;">Name</td><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-weight: 600;">${esc(data.name)}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Phone</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.phone)}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Email</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${data.email ? esc(data.email) : "—"}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Service</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.service)}</td></tr>
        ${data.eventType ? `<tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Event Type</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.eventType)}</td></tr>` : ""}
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Event Date</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.eventDate)}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Location</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.location)}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Faces</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${esc(data.faces)}</td></tr>
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666;">Preferred Time</td><td style="padding: 8px 0; border-bottom: 1px solid #eee;">${data.preferredTime ? esc(data.preferredTime) : "—"}</td></tr>
        ${data.message ? `<tr><td style="padding: 8px 0; color: #666; vertical-align: top;">Message</td><td style="padding: 8px 0;">${esc(data.message).replace(/\n/g, "<br>")}</td></tr>` : ""}
      </table>
...
export async function sendPaymentConfirmation(data: PaymentConfirmationData) {
  ...
  const clientHtml = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      ...
      <p>Hi ${esc(data.name)}, your deposit payment of <strong>${formattedAmount}</strong> for <strong>${esc(data.service)}</strong> on <strong>${esc(data.eventDate)}</strong> has been confirmed.</p>
      ...
      <div style="margin: 24px 0; padding: 20px; background: #fdf5f6; border-radius: 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr><td style="padding: 6px 0; color: #666; width: 140px;">Reference</td><td style="padding: 6px 0; font-family: monospace; font-size: 12px;">${esc(data.reference)}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Amount Paid</td><td style="padding: 6px 0; font-weight: 600;">${formattedAmount}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Service</td><td style="padding: 6px 0;">${esc(data.service)}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Event Date</td><td style="padding: 6px 0;">${esc(data.eventDate)}</td></tr>
        </table>
      </div>
  ...
  const ownerHtml = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; color: #666; width: 140px;">Client</td><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-weight: 600;">${esc(data.name)}</td></tr>
        ...
        <tr><td style="padding: 8px 0; color: #666;">Reference</td><td style="padding: 8px 0; font-family: monospace; font-size: 12px;">${esc(data.reference)}</td></tr>
      </table>
    </div>
  `;
...
export async function sendBookingConfirmation(data: BookingEmailData) {
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
      <h2 style="color: #c0687b;">Thank You, ${esc(data.name)}!</h2>
      <p>Your booking request for <strong>${esc(data.service)}</strong> on <strong>${esc(data.eventDate)}</strong> has been received.</p>
      ...
      <div style="margin: 24px 0; padding: 20px; background: #fdf5f6; border-radius: 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr><td style="padding: 6px 0; color: #666; width: 120px;">Service</td><td style="padding: 6px 0; font-weight: 600;">${esc(data.service)}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Event Date</td><td style="padding: 6px 0;">${esc(data.eventDate)}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Location</td><td style="padding: 6px 0;">${esc(data.location)}</td></tr>
          <tr><td style="padding: 6px 0; color: #666;">Faces</td><td style="padding: 6px 0;">${esc(data.faces)}</td></tr>
        </table>
      </div>
